...
2026-09-22 完成首轮实现、浏览器初验和发布准备。2026-09-23 用户授权在回滚有备案的条件下上线，首轮发布 `48650d2` 的记录见 [正式发布与回滚回执](DEPLOYMENT_20260923.md)，随后发布 [待办单击修复版 `818dfdb`](TODO_CALLBACK_20260923.md)。当前线上为 `6ccb02a`，包含 150 分钟结算报警和批次可见性说明，详见 [2026-09-24 验收与回滚回执](CALLBACK_EXPIRY_20260924.md)。
