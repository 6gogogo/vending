...
下列公网匿名登录页截图在运行状态加载完成后采集，右上角显示“模拟服务”；该标识不是操作步骤。App 使用手动验证码时明确提示向实例管理员获取一次性验证码，验证码输入框限制为 6 位，且不显示“获取验证码”按钮。截图未输入账号、密码、手机号或验证码。

后台登录页：

![公网后台登录页](assets/backoffice-login-1440x900-20260728-6e41cb3.png)

App 登录页以 390 CSS px × 844 CSS px 手机视口采集（PNG 为 DPR 2 的 780×1688）：

![App 手动验证码登录页（390×844）](assets/app-login-manual-390x844-20260728-6e41cb3.png)
