...
export const roleManuals: Record<RoleManualId, RoleManual> = {
  ...
  admin: {
    id: "admin",
    label: "实例管理员",
    summary: "管理当前实例的人员、货品、库存、柜机、领取规则和操作记录。",
    sections: [
      {
        title: "首次登录",
        steps: [
      ...
      },
      {
        title: "从 Excel 批量导入",
        steps: [
          "在“人员管理”下载标准 Excel 模板，不要修改第一行列名。",
          "填写姓名和手机号；区域、标签和特殊群体额度可按需填写。",
          "选择“特殊群体 / App 用户”或“商家”，上传文件并逐项修正页面提示的问题。",
          "核对预览后确认导入，再为商家分配柜机和开通后台账号。"
        ],
        note: "实例管理员和补货员需要逐个核对权限及柜机范围，不能从 Excel 批量创建。"
      },
      {
        title: "扫码领取和人工验证码",
        steps: [
          "新版小程序提供物资查询和扫码直接开门，免费领取不要求支付。",
          "在“人员管理”找到已启用的 App 用户，签发“APP / 小程序登录”用途的一次性验证码。",
          "验证码过期、撤销或使用后必须重新签发，不能多人共用。",
          "用户关门后，在领取记录和操作日志中查看实际取货结果；零元订单自动完成。"
        ]
      }
    ]
  },
  ...
  app: {
    id: "app",
    label: "App 用户",
    summary: "使用一次性验证码登录，查询物资，到柜扫码开门领取。",
    sections: [
      {
        title: "登录和查询",
        steps: [
          ...
          "进入“物资查询”查看商品和库存，无需选择数量或提交预约。",
          "查询不占用库存和领取额度；免费领取不会要求付款。"
        ]
      },
      {
        title: "到柜领取",
